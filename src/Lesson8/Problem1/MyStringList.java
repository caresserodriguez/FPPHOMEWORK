...
public class MyStringList {
    ...
    public String removeAt(int index){
        ...
        String[] temporary = new String[strArray.length];
        System.arraycopy(strArray, 0, temporary, 0, index);
        System.arraycopy(strArray, index + 1, temporary, index,
                strArray.length - (index + 1));
        strArray = temporary;
        --size;
        return temp;
    ...
    //I think the toString method is causing the clear method to not work. When I auto generate the toString method, the clear method works.
//    public void clear() {
//        for (int i = 0; i < size; i++) {
//            strArray[i] = null;
//        }
...
//    }
    ...
    public boolean containsAll(MyStringList other) {
        for (int i = 0; i < other.size; i++) {
            ...
            for (int j = 0; j < this.size; j++) {
                if (this.strArray[j] != null && this.strArray[j].equals(other.strArray[i])) {
                    found = true;
                    break;
                }
            }
	...
	public static void main(String[] args) {
        ...
        System.out.println("Index of Susan is: " + l.indexOf("Susan"));
        System.out.println("Removed person at index 2 : " + l.removeAt(2));
        System.out.println(l);

//        l.clear();
//        System.out.println(l);

        System.out.println(l.set(1, "Caresse"));
        System.out.println(l);
